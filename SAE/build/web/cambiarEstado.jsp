    ...
    <body>
        ...
        <footer>
            <div class="submit_link" style="width:94%;">
                Sede: <SELECT NAME="Sede" placeholder="Sede.." style="width:22%;"> 
...
{ 
   ...
   out.println("<option value='"+Sedes.get(i)+"'>"+Sedes.get(i).getNombreSede()+"</option>");

}
  
%>
                </SELECT> Carrera: <SELECT NAME="Sede" placeholder="Sede.." style="width:22%;"> </SELECT> 
                Asignatura: <SELECT NAME="Sede" placeholder="Sede.." style="width:22%;"> </SELECT> 
